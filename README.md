...
The Financial (Fintech) Cloud Project presents a mock financial technology application. The application features a RESTful API developed with Python. For the infrastructure, we use AWS, Terraform, Ansible, and Python.
...
This information can be found in the inventory.yml file.
...
2. Docker Compose Setup:
   - The docker-compose.yml file defines the services needed for the application, such as the web server and the PostgreSQL database.
   - Make sure the PostgreSQL service environment matches the value in the .env file.
...
Navraj Singh is a Cloud Engineer with experience in designing, deploying, and optimizing secure, scalable cloud infrastructures on AWS. He specializes in CI/CD, Terraform, and Kubernetes (EKS/AKS), focusing on building high-availability environments and automating deployments to ensure reliability and cost-efficiency.
